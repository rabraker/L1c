...
function xp = l1qc_logbarrier(x0, A, At, b, epsilon, lbtol, mu, ...
...
for ii = 1:lbiter
  ...
  [xp, up, ntiter] = L1qcTestData.l1qc_newton(x, u, A, At, b, epsilon, ...
                                              tau, newtontol, newtonmaxiter, cgtol, ...
                                              cgmaxiter, ii, verbose);
