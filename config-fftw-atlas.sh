...
# then
    export CPPFLAGS="-I/usr/local/atlas/include -I/usr/local/include -I/usr/local/MATLAB/R2018b/extern/include"
    export LDFLAGS="-L/usr/local/atlas/lib -L/usr/local/lib -L/usr/local/MATLAB/R2018b/bin/glnxa64"
